...
**So merely having breakfast is not the important thing,** **it’s what you eat for breakfast.** What you eat has a profound [effect on your willpower](http://www.willpowered.co/what-fuels-willpower). To exert willpower, the brain uses a specific energy source produced by the body called [glucose](http://en.wikipedia.org/wiki/Glucose). Glucose is produced in the bloodstream from the digestion of foods.
...
Not all people are as good at producing glucose efficiently in their blood stream as others. [Diabetics](http://en.wikipedia.org/wiki/diabetes) and people with [hypoglycemia](http://en.wikipedia.org/wiki/hypoglycemia), for example, have a harder time maintaining a consistent flow of glucose than others. This means if they are not able to treat the lack of glucose in their system through medication, they can run into some serious problems.
