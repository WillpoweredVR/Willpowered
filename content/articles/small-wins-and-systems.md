...
This does not mean that you shouldn’t have goals and dream of “building cathedrals”. But you should use them to simply set the direction that you want to go, rather than the major focus. Shift your focus to the daily activities and habits that you need to get from where you are to where you want to go. To do this, check out James Clear’s great article on [establishing systems, rather than goals](http://jamesclear.com/goals-systems)[.](http://jamesclear.com/goals-systems)
## **Conclusion**
Great things happen from doing the right things day after day. From [Jerry Seinfeld](http://www.willpowered.co/learn/the-seinfeld-method) to [Will Smith,](https://www.youtube.com/watch?v=npdAlXSkFwM) we see prominently successful people stressing the importance of focusing on simply winning the day. If we shift our focus to do the same, we will make the task less daunting, improve our process, and enjoy small wins along the way to our dreams.
